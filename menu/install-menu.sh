...
CLOUDFLARE_NOTE
  echo
  echo "Cloudflared final setup guided akışta otomatik çalışacak. Erken credential varsa auth sormaz."
...
run_full_install_pipeline(){
  ...
  cat <<'PIPE'
=========================================
 Homelab v2.4.4 - Guided full pipeline
=========================================
